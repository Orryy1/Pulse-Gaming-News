...
| Exact YouTube window candidate inspection and authority | `npm run ops:window-candidate-authority` | `tools/governed-youtube-window-candidate-authority.js` |
...
- `node --test tests/services/governed-youtube-window-candidate-authority.test.js`
- `node --test tests/ops/governed-youtube-window-candidate-authority-cli.test.js`
