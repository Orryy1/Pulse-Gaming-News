...
| Red Dead | alternate_source_required | 12 | 0 | 2 | segment_contains_black_frame | find_alternate_official_source_family |
...
- segment_contains_black_frame: 12
...
- Validated clip sources: 0
- Validated entities: none
- Missing entities: I can't download you. You
- Acquisition strategy: needs_first_segment_scan
- Latest render proof: not available
...
- Status: needs_first_segment_scan
- Alternate-source entities: none
- Unattempted entities: I can't download you. You
- Keep-sampling entities: none

| Entity | Status | Attempts | Validated | Source families | Top rejection | Recommendation |
| --- | --- | ---: | ---: | ---: | --- | --- |
| I can't download you. You | not_sampled | 0 | 0 | 0 | none | run_initial_segment_scan |

### Next Steps

- run_initial_segment_scan_for:I can't download you. You
- find_3_more_validated_gameplay_clip_windows
- find_3_more_validated_clip_sources
- acquire_exact_subject_images_or_official_motion_refs
- cover_missing_entities:I can't download you. You
- generate_approved_sleepy_liam_audio_after_visuals_are_ready
...
- Validated clip sources: 0
- Validated entities: none
- Missing entities: The next Tales Of
- Acquisition strategy: needs_first_segment_scan
- Latest render proof: not available
...
- Status: needs_first_segment_scan
- Alternate-source entities: none
- Unattempted entities: The next Tales Of
- Keep-sampling entities: none

| Entity | Status | Attempts | Validated | Source families | Top rejection | Recommendation |
| --- | --- | ---: | ---: | ---: | --- | --- |
| The next Tales Of | not_sampled | 0 | 0 | 0 | none | run_initial_segment_scan |

### Next Steps

- run_initial_segment_scan_for:The next Tales Of
- find_3_more_validated_gameplay_clip_windows
- find_3_more_validated_clip_sources
- acquire_exact_subject_images_or_official_motion_refs
- cover_missing_entities:The next Tales Of
- generate_approved_sleepy_liam_audio_after_visuals_are_ready
...
- Status: needs_first_segment_scan
- Alternate-source entities: none
- Unattempted entities: A New The Division PC Game
- Keep-sampling entities: none

| Entity | Status | Attempts | Validated | Source families | Top rejection | Recommendation |
| --- | --- | ---: | ---: | ---: | --- | --- |
| A New The Division PC Game | not_sampled | 0 | 0 | 0 | none | run_initial_segment_scan |

### Next Steps

- run_initial_segment_scan_for:A New The Division PC Game
- find_3_more_validated_gameplay_clip_windows
- find_3_more_validated_clip_sources
- acquire_exact_subject_images_or_official_motion_refs
