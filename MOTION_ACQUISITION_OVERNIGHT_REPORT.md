...
- Blockers: flash_proof_requires_motion_backbone, flash_proof_requires_three_validated_clip_sources, footage_backbone_clip_dominance_too_low, flash_proof_requires_validated_entity_coverage, flash_proof_requires_exact_subject_entity_coverage, flash_proof_blocks_cover_dominated_exact_assets
- Liam audio: approved_local_liam_audio_ready
- Exact assets: 12
- Motion frames: 0
- Validated clip refs: 3
- Validated clip sources: 1
- Projected clip dominance: 0.15
...
- Recommendation: do_not_render_yet
- Blockers: approved_liam_audio_missing, flash_proof_requires_motion_backbone, footage_backbone_clip_dominance_too_low, flash_proof_requires_footage_backbone_dominance
- Liam audio: local_liam_audio_not_flash_ready
- Exact assets: 26
- Motion frames: 1
- Validated clip refs: 6
- Validated clip sources: 5
- Projected clip dominance: 0.27
...
- Recommendation: do_not_render_yet
- Blockers: approved_liam_audio_missing, flash_proof_requires_motion_backbone, footage_backbone_clip_dominance_too_low, flash_proof_requires_footage_backbone_dominance, latest_render_forensic_warnings
- Liam audio: local_liam_audio_not_flash_ready
- Exact assets: 11
- Motion frames: 0
- Validated clip refs: 13
- Validated clip sources: 8
- Projected clip dominance: 0.45
