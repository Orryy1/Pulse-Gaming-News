...
module.exports = {
  ...
  classificationColour(classification) {
    ...
    if (c.includes("leak"))
      return { hex: "#EC4899", ffm: "0xEC4899", label: "LEAK" };
    if (c.includes("breaking"))
      return { hex: "#EC4899", ffm: "0xEC4899", label: "BREAKING" };
    if (c.includes("rumor") || c.includes("rumour"))
      return { hex: "#A855F7", ffm: "0xA855F7", label: "RUMOR" };
    if (c.includes("confirmed") || c.includes("verified"))
      return { hex: "#22D3EE", ffm: "0x22D3EE", label: "CONFIRMED" };
    if (c.includes("launch"))
      return { hex: "#22D3EE", ffm: "0x22D3EE", label: "LAUNCH" };
...
- Structure: Hook -> Source -> Technical detail -> Mid-roll pivot -> Impact -> CTA
- CTA: "Follow The Signal so you never miss a launch"
...
- "This is the part the keynote conveniently skipped."
- "But the real breakthrough is not the headline feature."
