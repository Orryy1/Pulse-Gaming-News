...
The main goal is achieved only when current evidence proves:

- accurate, differentiated content quality across a completed controlled sample
- statistically useful retention, subscriber and returning-viewer evidence
