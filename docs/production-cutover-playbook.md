...
| `USE_JOB_QUEUE`      | Legacy `node-cron` registries in `run.js` / `server.js` drive the pipeline                                                                                              | Unified scheduler from `lib/scheduler.js` enqueues into `jobs` table, `lib/services/jobs-runner.js` executes                                                                                                                                                                                             |
