    ...
    candidates.push(
      normaliseCandidate(
        story,
        {
          ...
          entity: entityMap.primary || "Pulse Gaming News",
        },
        "generated_brand_card",
        entityMap,
        candidates.length,
...
function renderAssetAcquisitionMarkdown(report) {
  ...
  if (report.exact_subject_summary) {
    lines.push(`Studio V2 selected-band eligible: ${report.exact_subject_summary.studio_v2_selected_band_eligible}`);
    lines.push(`Premium candidates: ${report.exact_subject_summary.premium_candidates}`);
  }
  lines.push("");
  lines.push("| story | verdict | budget | exact | runtime | selected band | before | after | deck | high tasks | key tasks |");
  lines.push("| --- | --- | --- | ---: | --- | --- | --- | --- | ---: | ---: | --- |");
...
function renderExactSubjectMarkdown(report) {
  ...
  lines.push(`- Studio V2 selected-band eligible: ${summary.studio_v2_selected_band_eligible || 0}`);
  ...
  lines.push("");
  lines.push("| story | exact | groups | context | repeated | runtime | selected band | counted | disqualified | reasons |");
  lines.push("| --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- |");
  for (const plan of report.plans || []) {
    const exact = plan.exact_subject_readiness || {};
