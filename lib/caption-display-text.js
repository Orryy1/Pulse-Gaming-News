...
const GRAND_THEFT_AUTO_STUTTER_SIX_RE =
  /\bGrand\s+Theft\s+Auto\s+(?:(?:s\s*i|s(?:i|y|igh)?|see(?:[-\s]+see)?|sea|c|size|sice|sic|sick|sig|sixty)[-\s]*(?:six|6)|siix)\b/gi;
const GTA_STUTTER_SIX_RE =
  /\bG\.?\s*T\.?\s*A\.?\s+(?:(?:s\s*i|s(?:i|y|igh)?|see(?:[-\s]+see)?|sea|c|size|sice|sic|sick|sig|sixty)[-\s]*(?:six|6)|siix)\b/gi;
