...
const COMMUNITY_DISCUSSION_TITLE_RE =
  /\b(?:what(?:'s| is| are)|which|who|how to|anyone else|do you|did we|have we|recommend|recommendations?|best|favou?rite|obscure|ever played|review thread|made me reali[sz]e|feel like|lost the magic|lose the magic|came across|had a .+ pointed|pointed this out|in chat|we need another|this moment|your game|my setup|rate my)\b/i;
...
function isCommunityDiscussionPrompt(story = {}) {
  ...
  const hasNewsVerb = hasSourceBackedNewsSignal(story);
