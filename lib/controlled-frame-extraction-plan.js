...
function isOfficialReference(reference) {
  ...
  const directOfficialPageReference =
    ...
    /(official_publisher_or_developer_trailer_page|official_game_website_media_page|platform_storefront_video_reference|official_platform_product_page|official_social_media_video|licensed_direct_media_url|operator_supplied_local_video)/.test(
      sourceType,
    );
  return (
    Boolean(source) &&
