...
function buildCommentOverlayHonesty(story) {
  ...
  if (hasVerifiedRedditReaction(story)) {
    ...
    return {
      ...
      comment_source_type: related ? "related_reddit_discussion" : "real_reddit_comments",
      comment_overlay_allowed: true,
      reason: related
        ? "Top-rated audience reaction has verified related Reddit discussion provenance."
        : "Reddit source with top_comment present.",
    };
  }
