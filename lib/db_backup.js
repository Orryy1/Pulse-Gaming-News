...
// Resolve from lib/db so SQLITE_DB_PATH (when set, e.g. on a Railway
// persistent volume) is honoured here too. Backups must co-locate with
// the live DB — otherwise they'd sit on the ephemeral container FS and
// disappear on redeploy, defeating the whole point of a backup.
