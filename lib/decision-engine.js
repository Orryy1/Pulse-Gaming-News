...
function scoreOne(
  ...
  const laneCheck = score.script_quality_auto_block || score.community_discussion_auto_block
  ...
  if (laneCheck.qualifies) {
    ...
    const publisherLane = score.script_quality_auto_block || score.community_discussion_auto_block
      ? { qualifies: false, reason: null }
    ...
    if (publisherLane.qualifies) {
      ...
      const freshConfirmedLane = score.script_quality_auto_block || score.community_discussion_auto_block
        ? { qualifies: false, reason: null }
