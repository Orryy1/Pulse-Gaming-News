...
function buildBlackOpsPortPricingAngle(facts, sourceName) {
  return {
    ...
    stakes:
      "The player question is simple: are these convenient classics, or another reminder that preservation can become a storefront upsell?",
    caveat:
...
function buildCyberpunkTrustDebtAngle(facts, sourceName) {
  return {
    ...
    stakes:
      "For fans, the useful question is whether CDPR's next reveal shows restraint, proof and playable detail before the hype machine gets loud again.",
    caveat:
...
function buildXboxFounderSkepticismAngle(facts, sourceName) {
  return {
    ...
    viewerValue:
      "The useful read is whether Xbox can make its next move feel like a plan instead of another mixed message.",
    payoff:
