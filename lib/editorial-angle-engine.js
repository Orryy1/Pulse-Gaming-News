...
function buildHandsOnDemoAngle(facts, sourceName) {
  ...
  return {
    lane: "hands_on_demo",
    hook: `${game} just gave players the test most previews skip: a demo.`,
    sourceLine:
      `${sourceName} reports ${game} has a hands-on demo beat${datePhrase}${platformPhrase}, giving players a way to judge the expansion early.`,
    tension:
    ...
    title: `${game} Demo Test`.slice(0, 60),
  };
}
...
function buildGameplayTrailerAngle(facts, sourceName) {
  ...
  return {
    ...
    viewerValue: isRacer
      ...
      : "For players, repeated play matters more than one perfect trailer moment.",
