...
function buildSteamMoneyAngle(facts, sourceName) {
  ...
  return {
    ...
    viewerValue:
      "The question is whether that early crowd keeps playing once the cheaper wave arrives.",
...
function buildSubscriptionAccessAngle(facts, sourceName) {
  ...
  return {
    ...
    viewerValue:
      "For players, the useful question is whether the lower barrier makes the game worth trying now.",
