...
function buildPs5ProPssrUpgradeAngle(facts, sourceName) {
  ...
  return {
    ...
    viewerValue:
      "For PS5 Pro owners, the useful question is simple: does the upgrade make normal play look noticeably clearer?",
    payoff:
    ...
    title: `${game}'s PS5 Pro Upgrade Has A Real Test`.slice(0, 60),
  };
}
...
function buildBethesdaLayoffRoadmapAngle(facts, sourceName) {
  return {
    ...
    viewerValue:
      "The next useful proof is staffing and production detail around each project, not another logo or distant promise.",
    payoff:
