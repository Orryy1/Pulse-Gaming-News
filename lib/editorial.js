...
const FILLER_PHRASES = [
  ...
  {
    pattern: /\bbut here'?s where it gets interesting\b[.,]?/gi,
    replace: "",
  },
  {
    pattern: /\byou won'?t believe what\b/gi,
    replace: "",
  },
  {
    pattern: /\bthis changes everything\b[.,]?/gi,
    replace: "",
  },
  {
    pattern: /\band that'?s not all\b[.,]?/gi,
    replace: "",
  },
  {
