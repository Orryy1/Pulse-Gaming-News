...
function chooseCanonicalScript(story = {}) {
  ...
  if (lightlyRepaired && lightlyRepairedQa?.result === "pass" && weakFailures.length === 0) {
    return {
