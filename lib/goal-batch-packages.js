...
function buildProofScript(story = {}, { subject, sourceName } = {}) {
  ...
  let lead = `${subject} has a real source detail, but not enough practical consequence for a strong Pulse short yet.`;
  let sourceBeat = `${source} says ${claim}.`;
  let impact = "For players, creators or the wider community, the missing piece is still practical: what changes, what disappears, or what they need to do next.";
  let payoff = "Until that detail is clear, this is a watch item rather than a finished take.";
