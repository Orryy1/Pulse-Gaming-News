...
function hydrateStoryWithExistingGoalArtifacts(story = {}, { existingArtifactRoot = "" } = {}) {
  ...
  if (audioManifest && typeof audioManifest === "object") {
    ...
    hydrated.audio_manifest = audioManifest;
    if (narrationPath) {
    ...
    if (audioManifest.word_timestamp_source) {
      hydrated.word_timestamp_source = audioManifest.word_timestamp_source;
    }
    if (audioManifest.word_timestamp_count) {
      hydrated.word_timestamp_count = audioManifest.word_timestamp_count;
    }
  }
