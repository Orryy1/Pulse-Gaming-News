...
function buildPlatformPublishManifest({ storyId = "", platformManifest = {}, generatedAt = "" } = {}) {
  return {
    ...platformManifest,
...
function targetFiles({
  ...
  const repairedPlatformManifest = buildPlatformPublishManifest({ storyId, platformManifest, generatedAt });
