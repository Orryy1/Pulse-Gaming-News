...
function renderGoalDryRunPublishPlanMarkdown(plan = {}) {
  ...
  if (plan.summary?.platform_publish_now_action_count != null) {
    lines.push(`Enabled-platform dry-run actions: ${plan.summary.platform_publish_now_action_count}`);
  }
  if (plan.summary?.human_review_required_action_count != null) {
    lines.push(`Human-review-gated actions: ${plan.summary.human_review_required_action_count}`);
  }
