...
function renderVisibleCardWindowEvidence(renderManifest = {}) {
  const windows = [
    ...
    renderManifest.clip_scene_plan?.card_visible_windows,
    renderManifest.clip_scene_plan?.cardVisibleWindows,
...
function hyperframesReadableDwellEvidence({ renderManifest = {}, renderStory = {}, directorBeatMap = {} } = {}) {
  ...
  } else if (declaresHyperframes && tooFastCardShots.length) {
    blockers.push(
