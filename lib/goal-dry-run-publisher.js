...
const MIN_HYPERFRAMES_READABLE_CARD_DURATION_S = READABLE_CARD_TIMING.minimum_visible_duration_s;
const MIN_COMPACT_PROOF_OVERLAY_DURATION_S = 2.6;
const MAX_COMPACT_PROOF_OVERLAY_DURATION_S = 4.2;
const MAX_HYPERFRAMES_READABLE_CARD_DURATION_S = READABLE_CARD_TIMING.maximum_visible_duration_s;
...
function readableCardDurationRequiredS(value = {}) {
  ...
  return cardTimingContract(value.kind || value.id || "context", text).planned_visible_duration_s;
}
