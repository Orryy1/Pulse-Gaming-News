...
function normaliseGtaViText(value = "") {
  return cleanText(value).replace(/\bGTA\s*6\b/gi, "Grand Theft Auto VI");
}
...
function scriptSubjectFor(canonical = {}) {
  ...
  const subject = normaliseGtaViText(canonical.canonical_subject || canonical.canonical_game);
...
function normaliseTtsRiskyDurationPhrases(value = "") {
  return cleanText(value)
    ...
    .replace(/\bGTA\s*6\b/gi, "Grand Theft Auto VI")
    .replace(
