...
function ownedExplainerClipPlan({ storyId, canonical = {}, artifactDir = "" } = {}) {
  ...
  const rows = [
    ...
    ["orbital_cluster_surface", titleWords(subject, 5), "counter-rotating subject cluster", "spatial_orbits"],
    ["radial_phase_field", titleWords(claim, 6), "radial phase comparison", "spatial_orbits"],
    ["constellation_drift_surface", titleWords(subject, 5), "depth-separated constellation drift", "spatial_orbits"],
    ["trajectory_arc_surface", titleWords(canonical.canonical_angle || title, 6), "asymmetric trajectory sweep", "spatial_orbits"],
