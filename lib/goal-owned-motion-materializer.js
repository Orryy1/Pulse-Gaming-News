...
const MIN_OWNED_EXPLAINER_CARD_DURATION_S = 10.5;
const MAX_OWNED_EXPLAINER_CARD_DURATION_S = 12;
...
async function materializeClip({
  ...
  await fs.writeJson(`${output}.json`, {
    ...
    card_kind: clip.readable_card_kind || clip.card_kind || ownedReadableCardKind(clip.asset_class),
    readable_text: clip.readable_text || clip.headline || null,
    minimum_readable_duration_s: clip.minimum_readable_duration_s || null,
    licence_basis: "owned_generated_editorial_motion_graphic",
    commercial_use_allowed: true,
    output,
  }, { spaces: 2 });
