...
function ownedExplainerClipPlan({ storyId, canonical = {} } = {}) {
  ...
  const rows = [
    ...
    ["signal_scan_surface", titleWords(subject, 5), "kinetic signal scan"],
    ["data_pulse_surface", titleWords(canonical.canonical_angle || title, 5), "data pulse motion surface"],
    ["source_lock_lower_third", source, "source lock lower third"],
    ["kinetic_broll_surface", titleWords(claim, 6), "kinetic editorial motion surface"],
