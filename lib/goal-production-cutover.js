...
function bridgeClipFromAsset(asset = {}, index = 0, fallbackSourceType = "owned_motion_clip") {
  ...
  const directVideoLike = /direct_video|hls_manifest|dash_manifest|official_trailer_segment|official_video|official_platform_product_page|official_social_media_video|official_game_page_direct_video|steam_storefront_video_reference|steam_movie|gameplay|trailer/i.test(
