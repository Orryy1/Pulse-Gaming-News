...
async function buildRendererStoryJson(
  ...
  if (
    ...
    cinematicSoundscapeRuntime.status !== "ready"
  ) {
    throw new Error(
      `cinematic_soundscape_runtime_blocked:${cinematicSoundscapeRuntime.blockers.join(
        ",",
      )}`,
    );
  }
  ...
  const selectedDirectorPlan = buildVisualV4DirectorPlan({
    story: {
      ...
      soundscape_asset_inventory:
        cinematicSoundscapeRuntime.status === "ready"
          ? cinematicSoundscapeRuntime.assets
          : [],
    },
  ...
  const story = {
    ...
    cinematic_soundscape_runtime_status:
      cinematicSoundscapeRuntime.status,
    cinematic_soundscape_runtime_blockers:
      cinematicSoundscapeRuntime.blockers,
    cinematic_soundscape_runtime_manifest_path:
      cinematicSoundscapeRuntime.manifest_path || null,
    cinematic_soundscape_runtime_manifest_sha256:
      cinematicSoundscapeRuntime.manifest_sha256 || null,
    cinematic_soundscape_manifest: {
      readiness: {
        status: cinematicSoundscapeRuntime.status,
        blockers: cinematicSoundscapeRuntime.blockers,
      },
      selected_assets:
        cinematicSoundscapeRuntime.status === "ready"
          ? cinematicSoundscapeRuntime.assets
