...
const MIN_READABLE_HYPERFRAMES_CARD_DURATION_S = 10.5;
...
function selectReadableHyperframesCardsForMotionBalance(cards = [], primaryClipCount = 0) {
  ...
  return prioritised.slice(0, maxCards);
}
...
function hyperframesPremiumShellEvidenceForStory({
  ...
  const selectedCards = selectReadableHyperframesCardsForMotionBalance(passingCards, primaryClipCount);
