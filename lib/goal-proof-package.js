...
function requiredYoutubeRightsDescription(story = {}, canonical = {}, attentionDescription = "") {
  ...
  const explicitNotice = cleanText(story.youtube_required_rights_notice);
  ...
  if (!rightsNotice.required) return "";
  const editorialText =
...
function buildPlatformNativePublishPacks({
  ...
  const youtubeDescription =
    requiredYoutubeRightsDescription(story, canonical, attentionDescription) || attentionDescription;
