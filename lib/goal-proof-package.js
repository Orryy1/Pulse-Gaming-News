...
function attentionPlatformTitle({ subject = "", title = "", angle = "", description = "", firstLine = "" } = {}) {
  ...
  if (
    /\b(?:gameplay|footage|combat|reveal trailer|gameplay reveal|gameplay trailer|official trailer|showcase)\b/i.test(
      evidenceText,
    )
  ) {
...
function attentionCoverHeadline({ canonical = {}, story = {}, subject = "", title = "", angle = "", firstLine = "" } = {}) {
  ...
  const repairedHeadline = [canonical.thumbnail_headline, story.suggested_thumbnail_text, canonical.suggested_thumbnail_text]
