...
function weakCoverHeadline(value = "", subject = "") {
  ...
  if (
    ...
    !/\b(?:\d+|[0-9]+ ?(?:gb|fps|k)|problem|risk|catch|warning|pressure|fight|broke|broken|why|before|after|free|paid|delay|leak|deal|price|storage|ssd|launch)\b/i.test(text)
  ) return true;
