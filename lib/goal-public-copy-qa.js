...
function scriptFieldDiverges(primaryScript = "", alternateScript = "") {
  ...
  const comparablePrimary = clean(normaliseCaptionDisplayText(primary)).toLowerCase();
  const comparableAlternate = clean(normaliseCaptionDisplayText(alternate)).toLowerCase();
