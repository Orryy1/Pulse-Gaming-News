...
function refreshPlatformNativeEvidence(evidence = null, outputs = {}, manifest = {}) {
  ...
  try {
    const recomputed = buildPlatformNativePublishPacks({
      story: manifest,
      canonical: manifest,
      platformOutputs: outputs,
      affiliateManifest: manifest.affiliate_link_manifest || manifest.commercial_intelligence || {},
      landingPage: manifest.landing_page_manifest || {},
