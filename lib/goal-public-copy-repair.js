...
function firstLineForTitle(title, subject, manifest = {}) {
  ...
  if (subject === "Hellraiser: Revival") return "Hellraiser: Revival picked October 8, and that is brave for all the wrong reasons.";
  if (
...
function storySpecificNarrationPlan({ claim = "", source = "", subject = "", title = "" } = {}) {
  ...
  if (subject === "MARVEL Tokon" && isMarvelTokonRosterStoryText(joined)) {
    ...
    return {
      ...
      script: clean(
        [
          firstLine,
          `${source || "PlayStation Blog"} says all three are joining Fighting Souls, and that is bigger than a famous-names roster drop.`,
  ...
  if (
    ...
    const firstLine = "Hellraiser: Revival picked October 8, and that is brave for all the wrong reasons.";
    return {
      firstLine,
      script: clean(
        [
  ...
  if (/stranger than heaven|five eras/i.test(joined)) {
    ...
    return {
      ...
      script: clean(
        [
          firstLine,
          "Xbox showed the Five Eras reveal during Xbox Partner Preview, and every era has to change investigation, fights and movement.",
          ...
          "If RGG Studio makes every era feel mechanically different, this can be more than moody crime footage.",
    ...
    return {
      ...
      script: clean(
        [
          ...
          "The catch is demand: scarcity can make hardware look more exciting, but every hands-on impression still has to justify the delay.",
