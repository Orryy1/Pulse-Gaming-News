...
function storySpecificNarrationPlan({ claim = "", source = "", subject = "", title = "" } = {}) {
  ...
  if (
    ...
    const firstLine = "Rockstar just turned GTA VI pre-orders into a buy, wait or skip argument.";
    return {
      firstLine,
      script: clean(
        [
          firstLine,
          `${source || "Xbox Wire"} says pre-orders open on June 25 after Rockstar put Jason and Lucia on the official cover art.`,
          "The cover is hype.",
