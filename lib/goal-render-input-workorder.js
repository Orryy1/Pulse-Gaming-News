...
function mapDryRunPreflightBlockers(rawBlockers = [], detailedFailures = []) {
  ...
  for (const code of codes) {
    ...
    if (
      /approved_voice:.*(?:gta_vi_spoken_stutter|gta_vi_opening_spoken_six_risk|non_native_rate_applied|tempo_stretch_applied|spoken_outro_misheard|spoken_outro_missing)/i.test(code) ||
      /content:approved_voice:.*(?:gta_vi_spoken_stutter|gta_vi_opening_spoken_six_risk|non_native_rate_applied|tempo_stretch_applied|spoken_outro_misheard|spoken_outro_missing)/i.test(code)
    ) {
