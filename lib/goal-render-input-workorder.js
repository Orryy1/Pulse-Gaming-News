...
function actionForReadableHyperframesMotionRepair(item = {}) {
  ...
  return {
    ...
    exact_missing_input: "fresh non-repeating owned HyperFrames/source-card motion clips with a 10.5s+ readable dwell floor",
    ...
    evidence: {
      minimum_readable_card_duration_s:
        Number(fileEvidence.minimum_readable_card_duration_s || 0) || 10.5,
    ...
    output_expectations: [
      ...
      "each readable card clip has durationS >= 10.5 unless its own readability contract requires longer",
