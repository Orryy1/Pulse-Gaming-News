...
async function inspectStoryPackage(storyPackage = {}, context = {}) {
  ...
  const analyticsPending = (!metrics || shallowMetrics) && upstream.length === 0;
  ...
  return {
    ...
    metrics_status: hasCompleteMetrics ? "complete" : shallowMetrics ? "shallow" : metrics ? "incomplete" : analyticsPending ? "pending" : "missing",
