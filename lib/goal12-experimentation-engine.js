...
async function inspectStoryPackage(storyPackage = {}, context = {}) {
  ...
  const metricsPending = upstream.length === 0 && !scorecard.hasMetrics;
  ...
  return {
    ...
    experiment_status: upstream.length ? "blocked_planning_only" : metricsPending ? "planned_pending_metrics" : "planned_or_scored",
    blockers,
