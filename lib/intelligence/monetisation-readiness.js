...
function naturallySupportsAffiliate(story) {
  ...
  const productAngle =
    /\b(release|launch|price|deal|sale|discount|hardware|console|controller|accessory|peripheral|headset|storage|download|pokemon go|steam deck|game pass)\b/.test(
      text,
    );
