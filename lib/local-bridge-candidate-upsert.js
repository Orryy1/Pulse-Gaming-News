...
async function validateLocalBridgePackage({
  ...
  if (directorBlockers.length) blockers.push("director_beat_map_has_blockers");
...
async function buildLocalBridgeCandidate({
  ...
  const spokenScript = cleanText(canonical.spoken_narration_script || canonical.tts_script || script);
