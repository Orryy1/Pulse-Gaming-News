...
function auditNarrationQaArtifacts({
  ...
  if (!captionManifest || typeof captionManifest !== "object") {
    ...
    const captionWordCount = positiveNumber(
      captionManifest.word_timestamp_count || captionManifest.word_count,
    );
  ...
  return {
    ...
    evidence: {
      ...
      caption_word_count: captionManifest && typeof captionManifest === "object"
        ? positiveNumber(captionManifest.word_timestamp_count || captionManifest.word_count)
        : null,
