...
function readinessFor({ topicality, references, targets, searchQueries, targetEntities, missingTargetEntities }) {
...
function renderOfficialTrailerReferenceMarkdown(report) {
  ...
  lines.push("");
  lines.push("| story | readiness | targets | missing targets | refs | searches | blockers |");
  lines.push("| --- | --- | ---: | --- | ---: | ---: | --- |");
