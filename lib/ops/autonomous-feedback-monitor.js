...
function selectedActionFromGuardedPreflight(report = {}) {
  if (!report || typeof report !== "object") return "";
  return actionIdFromDispatchAction(asArray(report.dispatch_ready_actions)[0]);
}
...
function buildAutonomousFeedbackReport({
  ...
  const currentGuardedActionId =
    selectedActionFromGuardedPreflight(guardedDispatchPreflightReport) ||
