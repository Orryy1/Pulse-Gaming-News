...
function validateCandidate({
  ...
  return {
    ...
    final_script: clean(artefacts.canonical?.narration_script || artefacts.narration?.final_transcript || artefacts.narration?.transcript),
    thumbnail_or_cover: {
      headline: clean(
...
function buildControlledRestartPack({
  ...
  const report = {
    ...
    repo_status: repoStatus || currentRepoStatus(cwd),
