...
function inspectPremiumVisualCampaign(manifest = {}) {
  if (!manifest || !Object.keys(manifest).length) {
    return { verdict: "not_evaluated", blockers: [], output_count: 0 };
  }
  ...
  if (outputs.length < 5) blockers.push("premium_visual_campaign_output_matrix_incomplete");
  return {
