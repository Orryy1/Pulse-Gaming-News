...
function classifyCurrentState({ candidate = {}, gap = {}, footage = {}, alternateRows = [] } = {}) {
  ...
  if (exactCount < MIN_EXACT_SUBJECT_ASSETS) blockingDimensions.push("exact_subject_assets");
...
function buildCurrentStateRow({ candidate = {}, gap = {}, footage = {}, alternateRows = [] } = {}) {
  ...
  return {
    ...
    recommended_commands: recommendedCommands(gap, candidate, alternateRows).slice(0, 8),
  };
}
