...
function buildPoisonActionTerminalStateReport({
  ...
  if (!skipped.length) blockers.push("poison_story_not_seen_in_selector_skip_list");
...
function buildNextWindowSchedulerVerification({
  ...
  if (selector.exhausted === true) blockers.push("no_next_guarded_live_action");
  ...
  return {
    ...
    skipped_before_next_action: asArray(selector.skipped_actions),
