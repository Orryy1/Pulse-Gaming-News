...
function normaliseReference(voice = {}, localTts = {}) {
  ...
  return {
    id: firstValue(
      ...
      voice.reference?.id,
      voice.reference?.referenceId,
      voice.reference?.reference_id,
    ...
    fileName: basenameOrNull(
      ...
      voice.reference?.file_name,
      voice.reference?.referenceFile,
      voice.reference?.reference_file,
    ...
    referenceHash: firstValue(
      ...
      voice.reference?.referenceHash,
      voice.reference?.reference_hash,
      voice.reference?.referenceSha1,
      voice.reference?.reference_sha1,
      voice.referenceHash,
    ...
    referencePresent: bool(firstValue(
      ...
      voice.reference?.referencePresent,
      voice.reference?.reference_present,
