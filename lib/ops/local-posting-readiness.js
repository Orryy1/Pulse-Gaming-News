...
function hasTunnelConnection(cutoverPlan = {}) {
...
function buildLocalPostingReadiness({
  ...
  const localTtsGreen = normaliseVerdict(ttsReport?.verdict) === "green";
  ...
  const tunnelConnected = hasTunnelConnection(cutoverPlan || {});
