...
function contextSentences(story = {}) {
  return [
    "For players, the useful question is what this changes before they buy, download, patch, preorder or wait.",
    "Anything beyond the source material stays clearly labelled, because the story only works if the facts stay narrow.",
    ...
    "The player-facing question is simple: does this change what deserves attention right now?",
  ];
}

function compactContextSentences() {
  return [
    "That is the player impact.",
    "The confirmed detail is the hook.",
    "Rumour and fact stay separate.",
    "The unknowns stay clearly labelled.",
    "The player decision point is simple.",
    "The concrete consequence comes first.",
  ];
}
