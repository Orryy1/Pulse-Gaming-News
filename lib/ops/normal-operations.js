...
function buildDiscordOperationsSummary(report = {}) {
  ...
  const lines = [
    ...
    `Candidates: ${candidate.ready_candidates || 0}/${candidate.ready_target || 0} ready | source-safe ${candidate.source_safe_candidates || 0} | V4 ${candidate.v4_ready_candidates || 0}`,
