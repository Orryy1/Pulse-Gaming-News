...
function shouldSendProduceCompletionDiscord(summary, env = process.env) {
  if (env.PRODUCE_NOTIFY_DISCORD !== "true") return false;
  return Boolean(
    summary &&
      (summary.shouldNotifyDiscord || env.PRODUCE_NOTIFY_NOOP === "true"),
  );
}
