...
function summariseLocalTtsRecoveryContext(report = null) {
...
function summariseRecentFailedCandidates(
  stories = [],
  { limit = 10, now = Date.now(), recentWindowHours = 24, localTtsReport = null } = {},
) {
  ...
  const localTtsRecovery = summariseLocalTtsRecoveryContext(localTtsReport);
...
function pillarRecentFailedCandidates({ stories, now, localTtsReportPath, localTtsReport } = {}) {
