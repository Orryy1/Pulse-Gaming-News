...
function buildActionRunway({ executorHandoffActionCount = 0, publishWindows24h = 5 } = {}) {
  const handoffCount = Number(executorHandoffActionCount || 0);
  ...
  const safeHandoffCount = Number.isFinite(handoffCount) && handoffCount > 0 ? handoffCount : 0;
