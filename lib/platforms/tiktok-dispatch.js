    ...
    ? (() => {
        ...
        return {
          ...
          do_not_reuse_for_tiktok_dispatch:
            voiceAudit.verdict === "reject" || blockers.length > 0,
        };
      })()
    : null;
...
function buildTikTokDispatchManifest(
  ...
  function readinessRank(pack) {
    ...
    if (pack.status === "missing_cover") return 9;
    if (pack.status === "missing_video_and_cover") return 10;
    if (pack.status === "missing_video") return 11;
    return 12;
  }
