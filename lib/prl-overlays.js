...
function buildCommentSwoop({ story, fontOpt, startS = 12.0, durationS = 6.0 }) {
  ...
  // Wide card with 3-line cap + balanced wrapping. The previous
  // 2-line cap with `…` truncation was reading as cut-off; the
  // 3-line variant fits typical Reddit top-comments without any
  // truncation needed. Anti-orphan rule still kicks in to prevent
