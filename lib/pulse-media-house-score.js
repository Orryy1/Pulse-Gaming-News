...
function audiencePullLanguage(text = "") {
  ...
  const hasCuriosity =
    /\b(?:why|how|what|secret|hidden|hides?|real|catch|risk|problem|fight|trial|pressure|warning|trust|threat|guarantee(?:d|s)?|ceiling|broke|turns?|makes?|ends?|ended|best|worst|worse|changed|into|test|exposes?|bet|prove|proves|wait|decid(?:e|ing|es)|argument|balance|polish|sharp|sharper|comeback|second wave)\b/i.test(value);
