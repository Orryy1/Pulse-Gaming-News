...
function buildQuoteCardFilter({
  ...
  const flashLane = treatment === "flash_lane";
  const backdropFilters = flashLane
    ? [
        `boxblur=12:4`,
        `eq=brightness=-0.08:saturation=0.92:contrast=1.12`,
        `drawbox=x=0:y=0:w=iw:h=ih:color=black@0.10:t=fill`,
        `drawbox=x=72:y=470:w=936:h=650:color=black@0.34:t=fill`,
        `drawbox=x=72:y=470:w=8:h=650:color=${ACCENT}@0.95:t=fill`,
      ]
    : [
        `boxblur=24:8`,
