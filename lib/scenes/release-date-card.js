...
function buildReleaseDateCardFilter({
  ...
  return [
    ...
    `fps=30`,
    `boxblur=14:4`,
    `eq=brightness=0.02:saturation=0.72:contrast=1.0`,
    // Vignette
    `drawbox=x=0:y=0:w=iw:h=330:color=black@0.30:t=fill`,
    `drawbox=x=0:y=h-430:w=iw:h=430:color=black@0.30:t=fill`,
    `drawbox=x=0:y=h/2-245:w=iw:h=490:color=black@0.18:t=fill`,
