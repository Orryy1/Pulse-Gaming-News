...
const DEFAULT_SCHEDULES = [
  ...
  // dispatch time.
  {
    ...
    cron_expr: "55 8 * * *",
    priority: 15,
    payload: { window_label: "publish_morning", enqueue_repair_on_runway: true, repair_limit: 8 },
    idempotencyTemplate: "publish_window_watchdog:{date}:08-55",
  },
  {
    ...
    cron_expr: "55 10 * * *",
    priority: 15,
    payload: { window_label: "publish_late_morning", enqueue_repair_on_runway: true, repair_limit: 8 },
    idempotencyTemplate: "publish_window_watchdog:{date}:10-55",
  },
  {
    ...
    cron_expr: "55 13 * * *",
    priority: 15,
    payload: { window_label: "publish_afternoon", enqueue_repair_on_runway: true, repair_limit: 8 },
    idempotencyTemplate: "publish_window_watchdog:{date}:13-55",
  },
  {
    ...
    cron_expr: "55 15 * * *",
    priority: 15,
    payload: { window_label: "publish_mid_afternoon", enqueue_repair_on_runway: true, repair_limit: 8 },
    idempotencyTemplate: "publish_window_watchdog:{date}:15-55",
  },
  {
    ...
    cron_expr: "55 18 * * *",
    priority: 15,
    payload: { window_label: "publish_primary", enqueue_repair_on_runway: true, repair_limit: 8 },
    idempotencyTemplate: "publish_window_watchdog:{date}:18-55",
  },
  ...
  // It is local-only: no posting, OAuth/token work or platform settings.
  {
    ...
    cron_expr: "25 * * * *",
    priority: 68,
    payload: { restart: true, prewarm: true },
