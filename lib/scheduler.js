...
const DEFAULT_SCHEDULES = [
  ...
  // dispatch time.
  {
    ...
    cron_expr: "30 7 * * *",
    priority: 15,
    payload: { phase: "T-90", window_label: "publish_morning", publish_hour_utc: 9, enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 9 * * *",
    priority: 15,
    payload: { phase: "T-90", window_label: "publish_late_morning", publish_hour_utc: 11, enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 12 * * *",
    priority: 15,
    payload: { phase: "T-90", window_label: "publish_afternoon", publish_hour_utc: 14, enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 14 * * *",
    priority: 15,
    payload: { phase: "T-90", window_label: "publish_mid_afternoon", publish_hour_utc: 16, enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 17 * * *",
    priority: 15,
    payload: { phase: "T-90", window_label: "publish_primary", publish_hour_utc: 19, enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
