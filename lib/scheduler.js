...
const DEFAULT_SCHEDULES = [
  ...
  // dispatch time.
  {
    ...
    cron_expr: "30 7 * * *",
    priority: 15,
    payload: { window_label: "publish_morning", enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 9 * * *",
    priority: 15,
    payload: { window_label: "publish_late_morning", enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 12 * * *",
    priority: 15,
    payload: { window_label: "publish_afternoon", enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 14 * * *",
    priority: 15,
    payload: { window_label: "publish_mid_afternoon", enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
  ...
  },
  {
    ...
    cron_expr: "30 17 * * *",
    priority: 15,
    payload: { window_label: "publish_primary", enqueue_repair_on_runway: true, enqueue_candidate_refill_on_runway: true, repair_limit: 8 },
