...
const DEFAULT_SCHEDULES = [
  ...
  // dispatch time.
  {
    ...
    cron_expr: "55 8 * * *",
    priority: 15,
    payload: { window_label: "publish_morning" },
  ...
  },
  {
    ...
    cron_expr: "55 10 * * *",
    priority: 15,
    payload: { window_label: "publish_late_morning" },
  ...
  },
  {
    ...
    cron_expr: "55 15 * * *",
    priority: 15,
    payload: { window_label: "publish_mid_afternoon" },
  ...
  },
  {
    ...
    cron_expr: "55 18 * * *",
    priority: 15,
    payload: { window_label: "publish_primary" },
  ...
  // has no GREEN story it should safely publish.
  {
    ...
    cron_expr: "5 */2 * * *",
    priority: 64,
    payload: { limit: 30, post_discord_on_red: true },
