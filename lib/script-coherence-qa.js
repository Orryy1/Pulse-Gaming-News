...
const VAGUE_FILLER_PATTERNS = [
  ...
  },
  {
    ...
    re: /\b(?:the clean angle|watching this short|not a hard sell|price story|audience watching|viewer value|public version|source-backed update|not a blank check|not a blank cheque|named source confirms|the useful caveat|the safest public version|what this changes for players after the headline fades)\b/i,
  },
];
