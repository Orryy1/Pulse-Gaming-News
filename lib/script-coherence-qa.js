...
const VAGUE_FILLER_PATTERNS = [
  ...
  },
  {
    ...
    re: /\b(?:signals? for pulse|pulse signals?|signal for pulse|signal first,\s*certainty later)\b/i,
  },
];
...
function runScriptCoherenceQa(story = {}, options = {}) {
  ...
  if (
    ...
    !normaliseForCompare(allScriptText).includes(normaliseForCompare(EXACT_CTA))
  ) {
