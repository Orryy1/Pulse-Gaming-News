...
const VAGUE_FILLER_PATTERNS = [
  ...
  },
  {
    ...
    re: /\b(?:here(?: is|'?s) what matters(?: now)?|the catch is what matters|the useful part is simple|the player-facing part is|the player impact is|for players,\s*the takeaway is simple|for players,\s*the point is simple|the payoff is knowing)\b/i,
  },
  {
