...
const PREPARATION_SCHEMA_VERSION =
  "pulse-autonomous-official-source-jit-preparation-v1";
const RESULT_SCHEMA_VERSION =
  "pulse-autonomous-official-jit-admission-packet-result-v1";
...
async function resolveAutonomousOfficialJitPreparationPlan(
  ...
  return Object.freeze({
    schema_version: "pulse-autonomous-official-jit-resolved-plan-v1",
