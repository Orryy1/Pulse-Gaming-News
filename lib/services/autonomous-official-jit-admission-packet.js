...
const PREPARATION_SCHEMA_VERSION =
  "pulse-autonomous-official-source-jit-preparation-v2";
const RESULT_SCHEMA_VERSION =
  "pulse-autonomous-official-jit-admission-packet-result-v2";
const RESOLVED_PLAN_SCHEMA_VERSION =
  "pulse-autonomous-official-jit-resolved-plan-v2";
