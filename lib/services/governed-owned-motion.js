...
`,
    close: `<text x="80" y="1788" font-family="Arial,Helvetica,sans-serif" font-size="28" font-weight="700" fill="#FFF" opacity=".72" letter-spacing="4">CHECKED • EXPLAINED • PLAYER-FIRST</text>
</g></svg>`,
  };
}
...
<text x="80" y="1585" font-size="33" font-weight="800" fill="#FFF">BRANCHING + SCALING</text>
${frame.close}`;
}
...
${wrapSvgText(intake.story.loop || "The new platform version has an official date.", { x: 80, y: 1425, maxChars: 26, lineHeight: 62, maxLines: 3, className: "releaseText" })}
<style>.releaseText{font-family:Arial,Helvetica,sans-serif;font-size:48px;font-weight:900;fill:#FFF}</style>
${frame.close}`;
}
