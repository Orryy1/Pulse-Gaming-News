...
function candidateRevision(candidate = {}) {
  ...
  const controlledExperimentObservationSha256 = exactHash(
    candidate.controlled_experiment_observation_sha256,
    admissionEvidence.controlled_experiment_observation
      ?.observation_sha256,
  );
  const workOrder =
  ...
  const bindings = {
    ...
    ...(controlledExperimentObservationSha256
      ? {
