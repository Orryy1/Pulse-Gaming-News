...
function buildPublishRunway({
  ...
  if (liveCandidates > 0) {
    ...
    nextAction =
      "Send the highest preflight-passing candidate to HUMAN_REVIEW or guarded scheduler mode; do not bypass platform, control-tower or disabled-platform gates.";
