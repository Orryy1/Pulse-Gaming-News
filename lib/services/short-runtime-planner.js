...
// Real local audio landed around 0.37-0.38s per cleaned spoken word, so
// the planner targets the 64-70s middle instead of grazing the 75s ceiling.
const DEFAULT_LOCAL_SECONDS_PER_WORD = 0.375;
