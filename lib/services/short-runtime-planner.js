...
// Calibrated from accepted Sleepy Liam local TTS plus the first repair
// batch on 2026-05-03. Long-form narration lands closer to 0.27-0.31s
// per cleaned spoken word than the original smoke-test estimate, so use
// a conservative budget and rely on post-generation duration QA before
// any local proof is considered usable.
const DEFAULT_LOCAL_SECONDS_PER_WORD = 0.28;
