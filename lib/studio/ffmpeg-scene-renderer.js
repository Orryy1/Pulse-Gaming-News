...
function buildTakeawayCardFilter({ slot, scene, fontOpt }) {
  ...
  return [
    ...
    "drawbox=x=118:y=h/2-178:w=844:h=356:color=black@0.34:t=fill:enable='gte(t\\,0.12)'",
    `drawbox=x=118:y=h/2-178:w=9:h=356:color=${ACCENT}@0.98:t=fill:enable='gte(t\\,0.18)'`,
    `drawbox=x=118:y=h/2-178:w='if(lt(t\\,0.55)\\,1+(844-1)*t/0.55\\,844)':h=6:color=${ACCENT}@0.98:t=fill`,
