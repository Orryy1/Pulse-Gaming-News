...
function buildEntityBadgeFilters(scene, fontOpt, layout = {}) {
  ...
  const kickerY = Number.isFinite(Number(layout.kickerY)) ? Number(layout.kickerY) : 104;
  const labelY = Number.isFinite(Number(layout.labelY)) ? Number(layout.labelY) : 158;
  const fade =
