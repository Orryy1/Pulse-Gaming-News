...
const GTA_VI_STUTTER_PATTERN = String.raw`(?:s\s+i\s+(?:six|6)|(?:s|si|sy|sigh|see|sea|c)\s+(?:six|6)|(?:see|sea|c|s|si|suh|sir)\s+a\s+(?:six|6)|(?:suh|sir)\s+(?:six|6)|see\s+see\s+(?:six|6)|siix|six\s+(?:six|6))`;
