...
function reportFromTimestampPayload(payload = {}, timestampPath = null) {
  ...
  const elevenlabs = meta.elevenlabs && typeof meta.elevenlabs === "object" ? meta.elevenlabs : null;
  const acoustic = {
  ...
  return {
    narration: {
      ...
      voiceMastering:
        ...
        null,
      elevenlabs,
      voiceId: elevenlabs?.voiceId || elevenlabs?.voice_id || meta.voiceId || meta.voice_id || null,
      modelId: elevenlabs?.modelId || elevenlabs?.model_id || meta.modelId || meta.model_id || null,
...
function mergeProofNarrationReport({
  ...
  return {
    narration: {
      ...
      elevenlabs:
        timestampNarration.elevenlabs ||
        manifest.elevenlabs ||
        manifest.meta?.elevenlabs ||
        null,
      voiceId:
        timestampNarration.voiceId ||
        manifest.voiceId ||
        manifest.voice_id ||
        null,
      modelId:
        timestampNarration.modelId ||
        manifest.modelId ||
        manifest.model_id ||
        null,
