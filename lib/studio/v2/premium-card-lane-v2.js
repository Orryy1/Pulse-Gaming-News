...
const MIN_HYPERFRAMES_READABLE_HOLD_S = READABLE_CARD_TIMING.minimum_visible_duration_s;
const MAX_HYPERFRAMES_READABLE_HOLD_S = READABLE_CARD_TIMING.maximum_visible_duration_s;
...
function internalReadableHoldFloorS({ readableText = "", wordCount = null, kind = "context" } = {}) {
  ...
  return cardTimingContract(timingKind, fallbackText).minimum_visible_duration_s;
}
