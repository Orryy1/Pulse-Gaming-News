...
const LIVING_MOTION_VERSION = "pulse_living_motion_v2";
...
function resolveLivingMotionGrammar(story = {}) {
  ...
  return Object.freeze({
    ...
    editorial: Object.freeze({
      ghost_opacity: Number((0.026 + energy * 0.018).toFixed(3)),
      ghost_font_size_px: Math.round(138 + energy * 40),
      ghost_y_px: 1020,
      ghost_drift_x_px: Math.round(12 + energy * 10),
      ghost_rate: Number((0.11 + energy * 0.08).toFixed(2)),
      ghost_start_s: 3.3,
      ghost_end_s: 4.9,
      persistent_status_word: false,
    }),
