...
function buildAcquisitionRunway(
  ...
  const operatorRequiredRows = blockedRows.filter((row) => row.render_input_operator_required === true);
...
function buildStudioV4SourceFamilyAcquisitionReport({
  ...
  const operatorRequiredRows = rows.filter((row) => row.render_input_operator_required === true);
