...
const RULES = [
  ...
  },
  {
    ...
    apply(text) {
      return text.replace(BLACK_FLAG_RESYNCED_TITLE_RE, "Black Flag reesynced");
    },
    description: "Black Flag Resynced -> joined TTS alias without a model-inserted sentence break",
  },
  {
