...
const TTS_PRONUNCIATION_PROFILE_VERSION = "gta-roman-title-v4";
...
function gtaSpokenVersion(version) {
  ...
  return lower === "vi" || lower === "6" || lower === "six" ? "V I" : "five";
}
...
const RULES = [
  ...
  // Soften to "online RPG".
  {
    ...
    apply(text) {
      return text
        .replace(GTA_SIX_STUTTER_RE, "Grand Theft Auto V I")
    ...
    description: "GTA V/VI title forms and six-stutters -> stable Grand Theft Auto five/V I local narration",
  },
  {
