...
function scoreHook({ story, script }) {
  ...
  if (!/\b(?:needed|warning|catch|paid|headline|problem|mistake|win|panic|risk|wild|signal|verdict|argument|free access|real story|gameplay|leak(?:ed)?|date|deal|drop(?:ped)?|review|score|handmade|job market|brutal|fake|pitch|console|release|hardware|demand|launch|more than|xcom)\b/i.test(hook)) {
    score -= 18;
  }
