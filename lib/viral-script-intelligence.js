...
function hasEarlyConcreteSourceDetail(script = "") {
  ...
  return /\b(?:scorpion|banshees?|marines?|covenant|forerunner|corridors?|sandbox|combat|gunfights?|camera|vehicles?|co[- ]op|enemy|enemies|weapons?|snow level|level|boss|builds?|map|mode|arena|movement|investigat(?:e|ion)|fights?|fighting|dodges?|melee|tank support|mission flow|controller feel|prologue|xenomorph|stealth|creature|horror pressure|moving too early|route|demo)\b/i.test(
    early,
  );
}
