...
function universalAssertion(sentence = "") {
  ...
  const assertedPredicate = /\b(?:is|are|has|have|points?|works?|requires?|supports?|includes?|excludes?|costs?|ships?|launches?|gets?|gives?|puts?|removes?|adds?|contains?|sells?|stays?|keeps?)\b/i;
