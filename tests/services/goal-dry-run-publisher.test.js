  ...
  const storyPackage = await makeStoryPackage(
    ...
    "Halo Campaign Evolved Needs A Cleaner Reveal",
    {
      ...
      renderManifestPatch: {
        ...
        overlay_card_windows: [],
        card_visible_windows: [
          { id: "scene_2_quote", kind: "quote", start_s: 1.2, end_s: 13.2, duration_s: 12 },
          { id: "scene_3_proof", kind: "proof", start_s: 13.6, end_s: 25.6, duration_s: 12 },
          { id: "scene_4_screenshot", kind: "screenshot", start_s: 26, end_s: 38, duration_s: 12 },
        ],
      },
    },
  );
