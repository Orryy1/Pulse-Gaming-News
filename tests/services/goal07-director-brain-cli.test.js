...
function directorPlan(storyId) {
  return {
    ...
    shot_plan: [
      ...
      { id: "source_lock", kind: "source_lock", startS: 2.2, durationS: 10.5, source: "IGN", visual_treatment: "large readable source bug" },
      { id: "motion_2", kind: "motion_clip", startS: 13, durationS: 3, source_family: "xbox", media_path: "clip2.mp4" },
    ],
    ...
    sfx_plan: {
      cues: [
        ...
        { target: "motion_2", atS: 13, family: "transition_hit" },
      ],
    },
