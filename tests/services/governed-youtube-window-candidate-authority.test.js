...
function autonomousPublicationAuthority(storyId, overrides = {}) {
  ...
  const claims = {
    verifier_id: "pulse-autonomous-official-publication-authority-v3",
    ...
    autonomous_visual_gate: {
      decision_file_sha256: "7b".repeat(32),
      decision_self_sha256: "7c".repeat(32),
      decision_authority: "SYSTEM_POLICY",
      authority_scope: AUTONOMOUS_AUTHORITY_TYPE,
    ...
    lineage: {
      ...
      autonomous_visual_gate_decision_sha256: "7b".repeat(32),
