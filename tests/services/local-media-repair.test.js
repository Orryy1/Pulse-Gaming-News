    ...
    stories: [
      {
        ...
        approved: true,
        full_script: "GTA 6 has a confirmed clue today. ".repeat(23),
    ...
    stories: [
      {
        ...
        approved: true,
        full_script: "Pokemon Go has a confirmed event today. ".repeat(23),
...
test("apply-local audio repair stamps accepted Sleepy Liam metadata", async () => {
  ...
  const story = {
    ...
    title: "Xbox confirms a new update",
    approved: true,
    full_script: "Xbox confirmed a useful detail today. ".repeat(26),
...
test("apply-local audio repair reports below-floor Liam proofs as rejected", async () => {
  const story = {
    ...
    title: "GTA 6 trailer evidence is stacking up",
    approved: true,
    full_script: "GTA 6 has a confirmed clue today. ".repeat(18),
