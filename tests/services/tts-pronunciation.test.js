...
test("GTA V and GTA VI title variants use stable spoken names", () => {
  ...
  assert.equal(
    applyGamingPronunciation("GTA V. I. now has one real preorder catch."),
    "Rockstar's next Grand Theft Auto now has one real preorder catch.",
  );
  assert.equal(
    applyGamingPronunciation("GTA 6 is not the same traffic story as G T A five."),
    "Rockstar's next Grand Theft Auto is not the same traffic story as Grand Theft Auto five.",
  );
  assert.equal(
    applyGamingPronunciation("G.T.A. VI preorders opened after GTA V stayed huge."),
    "Rockstar's next Grand Theft Auto preorders opened after Grand Theft Auto five stayed huge.",
  );
  assert.equal(
    applyGamingPronunciation("GTA Online is the retention test after GTA VI hype."),
    "Grand Theft Auto Online is the retention test after Rockstar's next Grand Theft Auto hype.",
  );
  assert.equal(
    applyGamingPronunciation("Rockstar just made Grand Theft Auto VI feel real in one image."),
    "Rockstar just made the next Grand Theft Auto feel real in one image.",
  );
  assert.equal(
    applyGamingPronunciation("Sony just made GTA VI's console pitch very direct."),
...
test("Black Flag Resynced stays one continuous spoken title", () => {
  assert.equal(
    applyGamingPronunciation(
...
test("colon-separated game titles lose the TTS pause but keep the title words", () => {
  ...
  assert.equal(
    applyGamingPronunciation("Marvel Tokon: Fighting Souls needs one clean title read."),
    "Marvel Tokon Fighting Souls needs one clean title read.",
  );
  assert.equal(
...
test("title pause repair preserves ordinary sentence boundaries", () => {
  assert.equal(
    applyGamingPronunciation("PS5 prices went up across Europe and the UK. PS5 Pro moved too."),
    "PlayStation five prices went up across Europe and the UK. PlayStation five Pro moved too.",
  );
  assert.equal(
    applyGamingPronunciation("Body. Follow Pulse Gaming for the next read."),
