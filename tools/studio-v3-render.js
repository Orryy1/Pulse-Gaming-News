...
const result = spawnSync(
  ...
  [path.join(ROOT, "tools", "studio-v2-render.js"), storyId],
  {
    ...
    env: {
      ...
      STUDIO_V21_HERO: process.env.STUDIO_V21_HERO || "true",
      STUDIO_V2_OUTPUT_SUFFIX: process.env.STUDIO_V2_OUTPUT_SUFFIX || "_v3",
      STUDIO_V2_AUTHORED: process.env.STUDIO_V2_AUTHORED || "true",
