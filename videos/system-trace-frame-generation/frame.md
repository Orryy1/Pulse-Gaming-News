...
typography:
  ...
  h1:      { fontFamily: "Space Grotesk", cqw: 7.5, weight: 800, lineHeight: 0.9, tracking: "-0.03em", lower: true }
...
- **Fonts** — already set to **Space Grotesk** (display) / **Inter** (body); ignore any preset font name lingering in prose.
